...
class OptimizationSettingsWidget(OptionsWidget):
    ...
    def __init__(self, show_sample_related_settings=True):
        ...
        if show_sample_related_settings:
            ...
            self.value_to_be_optimized_combo.activated.connect(self._update_name_of_value_to_be_optimized)
        ...
        self.solver_combo.activated.connect(self._update_solver)
    ...
    def _update_name_of_value_to_be_optimized(self):
        name_of_value_to_be_optimized = self.value_to_be_optimized_combo.currentText()
