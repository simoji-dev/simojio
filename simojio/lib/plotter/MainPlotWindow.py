...
class MainPlotWindow(QtWidgets.QMainWindow):
    """
    Window that shows the plots and numerical results created during a module run of simojio. The plots are sorted into
    ...
    def __init__(self):
        ...
        self.setWindowTitle("simojio plot window")

        # -- set simojio icon in window --
        simoji_icon = QtGui.QIcon(icon_path('simojio_logo.svg'))
