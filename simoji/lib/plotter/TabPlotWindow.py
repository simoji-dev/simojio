...
from simoji.lib.plotter.SinglePlotWidget import SinglePlotWidget
import simoji.lib.OptimizationResultsContainer
from simoji.lib.plotter.OptimizationResultsWidget import OptimizationResultsWidget
...
class TabPlotWindow(QtWidgets.QMainWindow):
    ...
    def add_optimization_results(self,
                                 opt_results: simoji.lib.OptimizationResultsContainer.OptimizationResultsContainer):
