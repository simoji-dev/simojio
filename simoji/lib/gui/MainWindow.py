...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, setting_path, app: QtWidgets.QApplication):
        ...
        self.toolbar.setObjectName("simoji toolbar")
    ...
    def init_ui(self):
        ...
        simoji_icon = QtGui.QIcon(BasicFunctions.icon_path('simoji_logo.svg'))
    ...
    def _write_readme(self, save_path: str, app: QtWidgets.QApplication, global_settings: GlobalSettingsContainer):
        ...
        description_str = "# Description:\tContains results of simoji module '" + module_name \
